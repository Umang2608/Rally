...
node
{
    ...
    if (env.UNIT_TESTING == 'True')
    {
	    try {
		    ...
		    def response = bat(script: """curl -g --header "zsessionid":"_7cIVFUMTAe5YRxqNYHuc7obb0aBlXM1WYurWU8" -H "Content-Type":"application/json" -d"{\\"Defect\\":{\\"Name\\":\\"Automated Defect Logging\\",\\"Severity\\": \\"Cosmetic\\", \\"Priority\\": \\"Resolve Immediately\\", \\"State\\": \\"Open\\",\\"Requirement\\": \\"${usno}\\",\\"Description\\": \\"Oops! Unit test failed, check Jenkins console output here: ${jenkins}\\"}}" https://rally1.rallydev.com/slm/webservice/v2.0/defect/create""",returnStdout: true).trim()
